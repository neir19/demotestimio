Feature: Reserva de viaje en Testim.io
  ...
  Scenario Outline: Reservar un viaje exitosamente
    ...
    Examples:
      ...
      | 2026-07-15 | 2026-07-22   | 2       | 1     | 80          | Tongli  | PROMO2026         | Juan Perez  | juan@email.com  | 123-45-6789          | +17878795412 | src/test/resources/test.txt |
      | 2026-08-1  | 2026-08-17   | 1       | 2     | 10          | Tongli  | BIENVENIDO        | Maria Gomez | maria@email.com | 987-65-4321          | +7877654321  | src/test/resources/test.txt |
